      ...
      {isMediumScreen && (
        ...
        <div className="text-2xl sm:text-2xl lg:text-2xl mb-2 px-24 py-2 font-light lg:font-light">
          ...
          <div className="flex flex-col md:flex-row justify-start mb-2 px-24 py-2 text-center mt-10">
            <button
              type="button"
              className="text-[#213A52] border border-[#213A52] hover:bg-[#213A52] hover:text-black focus:outline-none shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-bold rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 hover:cursor-pointer hover:bg-[#D7E5ED] hover:text-[##213A52]"
              onClick={() => {
